...
let $head := "BASE_URI&#09;TITLE&#09;DATE&#09;FORMAT&#09;CONTRIBUTOR&#09;SUBJECT&#09;DESCRIPTION&#09;SOURCE&#09;RIGHTS&#09;FILE_PATH&#09;FILE_NAME"
...
let $line := fn:string-join((fn:base-uri($individual),$workTitle, $date, $workType, $workAgents, $subject, $workDescription, $source, $rights, $filePath, $fileName), '&#09;')
